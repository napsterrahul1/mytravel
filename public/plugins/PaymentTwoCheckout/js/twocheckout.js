jQuery(function ($) {
    "use strict"
    if (myTravel_gateways_twocheckout.twocheckout_publishable_key === '') {
    ...
    var tokenRequest = function () {
        ...
        var args = {
            sellerId: myTravel_gateways_twocheckout.twocheckout_account_number,
            publishableKey: myTravel_gateways_twocheckout.twocheckout_publishable_key,
            ccNo: card_number,
            cvv: card_cvc,
