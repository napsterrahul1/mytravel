<div class="panel">
    <div class="panel-title"><strong><?php echo e(__("Adventure Locations")); ?></strong></div>
    <div class="panel-body">
        ...
        <?php endif; ?>
        <div class="form-group">
            <label class="control-label"><?php echo e(__("Real Adventure address")); ?></label>
            <input type="text" name="address" id="customPlaceAddress" class="form-control" placeholder="<?php echo e(__("Real Adventure address")); ?>" value="<?php echo e($translation->address); ?>">
        </div>
        <?php if(is_default_lang()): ?>
            <div class="form-group">
...
</div><?php /**PATH C:\xampp\htdocs\mytravel\modules/Tour/Views/admin/tour/tour-location.blade.php ENDPATH**/ ?>