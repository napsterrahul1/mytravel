...
<?php $__env->startSection('script.body'); ?>
    ...
    <script>
        ...
        $('.dungdt-form-payout-btn').on('click',function () {
            ...
            if(!ids || !ids.length){
                myTravelApp.showError("<?php echo e(__('Please select at lease one item')); ?>")
                return;
            }
        ...
        $('.dungdt-form-payout-save').on('click',function () {
            ...
            if(!status){
                myTravelApp.showError("<?php echo e(__("Status is empty")); ?>");
                return;
            }
            var ids = $('.check-item:checked').map(function(){
                return $(this).val();
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mytravel\modules/Vendor/Views/admin/payouts/index.blade.php ENDPATH**/ ?>