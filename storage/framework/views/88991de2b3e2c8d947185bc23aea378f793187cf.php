...
<?php else: ?>
    <?php
        if(!empty($page_title)){
            $page_title .= " - ".setting_item_with_lang('site_title' ,false,'OneClickSolution');
        }else{
            $page_title = setting_item_with_lang('site_title' ,false,'OneClickSolution');
        }
    ?>
...
<?php endif; ?>
<?php /**PATH C:\APPS\htdocs\ALL\mytravel\modules/Layout/parts/seo-meta.blade.php ENDPATH**/ ?>