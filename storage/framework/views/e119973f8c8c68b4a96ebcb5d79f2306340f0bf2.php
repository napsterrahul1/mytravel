        ...
        <div class="row">
            <div class="col-12 col-lg-5">
                ...
                <form class="form bravo-form-register-vendor" method="post" action="<?php echo e(route('vendor.register')); ?>">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="licence" autocomplete="off" placeholder="<?php echo e(__("Trade license No")); ?>">
                        <span class="invalid-feedback error "></span>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="imirate" autocomplete="off" placeholder="<?php echo e(__("Emirates Id")); ?>">
                        <span class="invalid-feedback error"></span>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\xampp\htdocs\mytravel\modules/Vendor/Views/frontend/blocks/form-register/index.blade.php ENDPATH**/ ?>