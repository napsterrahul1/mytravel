        ...
        <div class="bravo-list-item">
            <div class="d-flex justify-content-between align-items-center mb-4 topbar-search">
                <h3 class="font-size-21 font-weight-bold mb-0 text-lh-1">
                    <?php if($rows->total() > 1): ?>
                        <?php echo e(__(":count Adventures found",['count'=>$rows->total()])); ?>
            ...
            <div class="list-item">
                <div class="row">
                    ...
                    <?php else: ?>
                        <div class="col-lg-12">
                            <?php echo e(__("Adventures not found")); ?>
...
<?php /**PATH C:\xampp\htdocs\mytravel\modules/Tour/Views/frontend/layouts/search/list-item.blade.php ENDPATH**/ ?>