...
<div class="header-logo flex-shrink-0">
    <h3 class="logo-text"><a href="<?php echo e(url('/admin')); ?>"><?php echo e(__('OneClickSolution')); ?> <span class="app-version">
...
<?php /**PATH C:\xampp\htdocs\mytravel\modules/Layout/admin/parts/header.blade.php ENDPATH**/ ?>