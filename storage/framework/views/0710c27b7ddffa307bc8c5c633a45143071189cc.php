    ...
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                <?php if(is_default_lang()): ?>
                    <div class="form-group">
                        <label><?php echo e(__("Logo White")); ?></label>
                        <div class="form-controls form-group-image">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls form-group-image">
                            <?php echo \Modules\Media\Helpers\FileHelper::fieldUpload('logo_id_2',$settings['logo_id_2'] ?? ''); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <div id="topbar_left_text_editor" class="ace-editor" style="height: 200px" data-theme="textmate" data-mod="html"><?php echo e(setting_item_with_lang('topbar_left_text',request()->query('lang'))); ?></div>
...
<?php $__env->stopSection(); ?><?php /**PATH C:\xampp\htdocs\mytravel\modules/Core/Views/admin/settings/groups/general.blade.php ENDPATH**/ ?>