<div class="form-group-item">
    ...
    <div class="g-items-header">
        <div class="row">
            <div class="col-md-2 text-left d-none"><?php echo e(__("Image")); ?></div>
            <div class="col-md-6 text-left"><?php echo e(__("Title - Desc")); ?></div>
...
</div><?php /**PATH C:\xampp\htdocs\mytravel\modules/Tour/Views/admin/tour/itinerary.blade.php ENDPATH**/ ?>