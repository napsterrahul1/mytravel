...
class FlightController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $markers = [];
        if (!empty($list->Response->Results[0])) {
            foreach ($list->Response->Results[0] as $row) {
    ...
    public function authenticate(){
        //
                ...
                $payload = json_encode( array( "ClientId"=> 'ApiIntegrationNew','UserName'=>'flyproplus','Password'=>'flyproplus@123','EndUserIp'=>'127.0.0.1' ) );
