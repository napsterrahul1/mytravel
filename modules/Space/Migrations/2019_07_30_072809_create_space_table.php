...
class CreateSpaceTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('bc_spaces', function (Blueprint $table) {
        ...
        Schema::create('bc_space_translations', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bc_space_term', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bc_space_dates', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('bc_spaces');
        Schema::dropIfExists('bc_space_translations');
        Schema::dropIfExists('bc_space_term');
        Schema::dropIfExists('bc_space_dates');
    }
}
