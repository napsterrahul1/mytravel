...
class BookingController extends \App\Http\Controllers\Controller
{
    ...
    public function checkout($code)
    {
        ...
        if($booking->status != 'draft'){
            if($is_api){
                return $this->sendError(__("Booking data not Proper"))->setStatusCode(401);
            }else{
                return redirect('/');
            }
    ...
    public function doCheckout(Request $request)
    {
        ...
        // Normal Checkout
        $booking->payment = $request->input('bravo_stripe_token1') ? $request->input('bravo_stripe_token1') : 'yes';
    ...
    public function addToCart(Request $request)
    {
        ...
        //     return $this->sendError(__("You have to login in to do this"))->setStatusCode(401);
        // }
        // if(Auth::user() && setting_item('enable_verify_email_register_user')==1){
        //     return $this->sendError(__("You have to verify email first"), ['url' => url('/email/verify')]);
        // }
