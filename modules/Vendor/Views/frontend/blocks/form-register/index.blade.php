        ...
        <div class="row">
            <div class="col-12 col-lg-5">
                ...
                <form class="form bravo-form-register-vendor" method="post" action="{{route('vendor.register')}}">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="licence" autocomplete="off" placeholder="{{__("Trade license No")}}">
                        <span class="invalid-feedback error error-business_name"></span>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="emirate" autocomplete="off" placeholder="{{__("Emirates Id")}}">
                        <span class="invalid-feedback error error-business_name"></span>
                    </div>
