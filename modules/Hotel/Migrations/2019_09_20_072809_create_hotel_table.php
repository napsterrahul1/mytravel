...
class CreateHotelTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('bc_hotel_translations', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bc_hotel_term', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bc_hotel_room_translations', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('origin_id')->unsigned();
            $table->string('locale')->index();
        ...
        Schema::create('bc_hotel_room_term', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('term_id')->nullable();
            $table->integer('target_id')->nullable();
            $table->bigInteger('create_user')->nullable();
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('bc_hotel_translations');
        Schema::dropIfExists('bc_hotel_term');

        Schema::dropIfExists('bc_hotel_rooms');
        Schema::dropIfExists('bc_hotel_room_translations');
        Schema::dropIfExists('bc_hotel_room_term');
