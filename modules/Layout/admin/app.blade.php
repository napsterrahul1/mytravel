...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'OneClickSolution'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('OneClickSolution by')}} <a href="{{__('#')}}" target="_blank">{{__('Portal Perfect Team')}}</a>
                    </div>
                    <div class="col-md-6">
