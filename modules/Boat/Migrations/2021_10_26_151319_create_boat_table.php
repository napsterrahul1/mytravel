...
class CreateBoatTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('bc_boats', function (Blueprint $table) {
        ...
        Schema::create('bc_boat_translations', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bc_boat_term', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bc_boat_dates', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('bc_boats');
        Schema::dropIfExists('bc_boat_translations');
        Schema::dropIfExists('bc_boat_term');
        Schema::dropIfExists('bc_boat_dates');
    }
}
