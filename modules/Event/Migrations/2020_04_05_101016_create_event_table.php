...
class CreateEventTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('bc_events', function (Blueprint $table) {
        ...
        Schema::create('bc_event_translations', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bc_event_term', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bc_event_dates', function (Blueprint $table) {
            $table->bigIncrements('id');
    ...
    {
        Schema::dropIfExists('bc_events');
        Schema::dropIfExists('bc_event_translations');
        Schema::dropIfExists('bc_event_dates');
    }
}
