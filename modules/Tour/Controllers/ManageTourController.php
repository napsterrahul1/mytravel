...
class ManageTourController extends FrontendController
{
    ...
    public function manageTour(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'  => __("Manage Adventure"),
        ];
    ...
    public function createTour(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'    => __("Create Adventure"),
        ];
    ...
    public function editTour(Request $request, $id)
    {
        ...
        $row = $row->find($id);
        if (empty($row)) {
            return redirect(route('tour.vendor.index'))->with('warning', __('Adventure not found!'));
        }
