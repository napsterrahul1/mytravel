...
class Flight extends Bookable
{
    ...
    public static function searchflight(Request $request){
        //
                ...
                $payload = json_encode( array( "TokenId"=>$request->session()->get('key') ,'Origin'=>'BOM','Destination'=>'DEL','EndUserIp'=>$request->ip(),'AdultCount'=>1,'ChildCount'=>0,'InfantCount'=>0,'JourneyType'=>1,'FlightCabinClass'=>1,'PreferredDeparture'=>'2022-06-13T00:00:00','PreferredArrivalTim'=>'2022-06-13T00:00:00' ) );
