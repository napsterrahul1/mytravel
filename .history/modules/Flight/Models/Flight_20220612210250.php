...
class Flight extends Bookable
{
    ...
    public function searchflight(Request $re){
        //
                $ch = curl_init();
                ...
                $payload = json_encode( array( "TokenId"=> ,'Origin'=>'flyproplus','Destination'=>'flyproplus@123','EndUserIp'=>'122222222','AdultCount'=>1,'ChildCount'=>0,'InfantCount'=>0,'JourneyType'=>1,'FlightCabinClass'=>1,'PreferredDeparture'=>'','PreferredArrivalTim'=>'' ) );
