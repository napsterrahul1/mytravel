...
class Flight extends Bookable
{
    ...
    public stafunction searchflight(Request $request){
        //
                $ch = curl_init();
                ...
                $payload = json_encode( array( "TokenId"=>$request->session()->get('key') ,'Origin'=>'flyproplus','Destination'=>'flyproplus@123','EndUserIp'=>'122222222','AdultCount'=>1,'ChildCount'=>0,'InfantCount'=>0,'JourneyType'=>1,'FlightCabinClass'=>1,'PreferredDeparture'=>'','PreferredArrivalTim'=>'' ) );
