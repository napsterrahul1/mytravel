...
class UpdateFrom140To150 extends Migration
{
    ...
    public function up()
    {
        Schema::table('bc_attrs', function (Blueprint $table) {
            if (!Schema::hasColumn('bc_attrs', 'display_type')) {
                $table->string('display_type',255)->nullable();
            }
            if (!Schema::hasColumn('bc_attrs', 'hide_in_single')) {
        ...
        Schema::create('bc_cars', function (Blueprint $table) {
        ...
        Schema::create('bc_car_translations', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bc_car_term', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bc_car_dates', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('bc_cars');
        Schema::dropIfExists('bc_car_translations');
        Schema::dropIfExists('bc_car_term');
        Schema::dropIfExists('bc_car_dates');
    }
}
